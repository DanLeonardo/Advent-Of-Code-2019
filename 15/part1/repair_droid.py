...
class DroidController:
	...
	def run(self):
		...
		oxygen_pos = self.find_oxygen_system()
		if oxygen_pos is None:
			print('Oxygen System not found')
		else:
			print('Oxygen System at (%d, %d)' % (oxygen_pos[0], oxygen_pos[1]))
			path_to_oxygen = self.find_path_to_target((0, 0), oxygen_pos)
			print(len(path_to_oxygen))
